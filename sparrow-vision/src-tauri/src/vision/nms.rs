...
pub fn suppress_overlaps(
  mut raw: Vec<RawDetection>, iou_threshold: f32, max_detections: usize, diagnostics: &mut RecognitionDiagnostics,
) -> NmsResult {
  raw.sort_by(|a, b| b.confidence.partial_cmp(&a.confidence).unwrap_or(Ordering::Equal));
